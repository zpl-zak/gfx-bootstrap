...
wget https://raw.githubusercontent.com/zpl-c/zpl-old/master/include/zpl.h -O zpl.h 
wget https://raw.githubusercontent.com/zpl-c/zpl-old/master/include/zpl_gl3w_gen.py -O zpl_gl3w_gen.py 
